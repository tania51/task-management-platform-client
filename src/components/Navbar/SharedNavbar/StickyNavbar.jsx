                ...
                user ?
                        ...
                        <div className="flex gap-3 font-semibold items-center">
                          ...
                          <MenuHandler>
                            <Avatar
                              ...
                              alt="avatar"
                              src={user?.photoURL}
                              className="border border-green-500 shadow-xl shadow-green-900/20 ring-4 ring-green-500/30 w-10 h-10 rounded-full"
                            />
                          </MenuHandler>
                        </div>
                        <MenuList>
                          <Link to="/dashboard">
                            <MenuItem className="flex items-center gap-2">
                              <MdSpaceDashboard className="text-orange-600" />
                          ...
                          <MenuItem className="flex items-center gap-2">
                            ...
                            <Typography onClick={logOutHandeler} variant="small" className="font-medium text-white">
                              Sign Out
                            </Typography>
                          </MenuItem>
                        </MenuList>
                  ...
                  <Link to="/login">
                    <Button
                      variant="text"
                      size="sm"
                      className="hidden lg:inline-block bg-orange-500 text-white rounded"
                    >
                      <span>Log In</span>
                    </Button>
                  </Link>
